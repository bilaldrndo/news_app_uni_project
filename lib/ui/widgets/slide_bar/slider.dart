...
import 'package:project_code/ui/widgets/slide_bar/app_bar.dart';
import 'package:project_code/ui/widgets/slide_bar/slider_direction.dart';
...
class SliderMenuContainerState extends State<SliderMenuContainer> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animationDrawerController = AnimationController(vsync: this, duration: Duration(milliseconds: widget.animationDuration));

    animation = Tween<double>(begin: widget.sliderMenuCloseSize, end: widget.sliderMenuOpenSize).animate(
      CurvedAnimation(
                ...
                AnimatedBuilder(
                  ...
                  builder: (_, child) {
                    return Transform.translate(
                      offset: Utils.getOffsetValueForShadow(widget.slideDirection, animation.value, widget.sliderMenuOpenSize),
                      child: child,
                    );
                  },
                  child: Container(
                      ...
                      children: <Widget>[
                        if (widget.hasAppBar)
                          SliderAppBar(
                            ...
                            onTapActionIcon: widget.onTapActionIcon,
  ...
  void _onHorizontalDragUpdate(
    ...
    if (dragging && widget.slideDirection == SlideDirection.LEFT_TO_RIGHT || widget.slideDirection == SlideDirection.RIGHT_TO_LEFT) {
